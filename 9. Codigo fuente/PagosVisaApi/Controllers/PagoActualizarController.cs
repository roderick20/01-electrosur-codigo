...
namespace Electrosur.Controllers
{
    /*******************************************************************************************
* PagosVisaWeb
* Este controlador es para actualizar el pago
...
* *****************************************************************************************/
    ...
    public class PagoActualizarController : ControllerBase
    {
        ...
        public PagoActualizarController(
        ...
        [HttpPost]
        public IActionResult Index([FromBody] FormPagoActualizar pagoActualizar)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var gUsruniqueId = new Guid(pagoActualizar.usridUsuario);
