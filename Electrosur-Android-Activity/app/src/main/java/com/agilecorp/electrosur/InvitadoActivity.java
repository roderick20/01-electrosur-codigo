...
public class InvitadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText tvNumberDocumento = this.findViewById(R.id.tv_numberdocumento);
        ...
        botonBuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tvNumberDocumento.getText().toString().equals("")) {
                    Toast.makeText(getApplicationContext(), "Ingrese número de DNI", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                params.put("dni", tvNumberDocumento.getText().toString());
                String url = Singleton.getInstance().getUrl() + "api/PagosInvitado";
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                try {
                    VisaNet.authorization(InvitadoActivity.this, data, custom);
                } catch (Exception e) {
        ...
        if (requestCode == VisaNet.VISANET_AUTHORIZATION) {
            if (data != null) {
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    final Intent intent = new Intent(this, ResultadoOKInvitadoActivity.class);
                    ...
                    final Intent intent = new Intent(this, ResultadoMalInvitadoActivity.class);
                    startActivity(intent);
